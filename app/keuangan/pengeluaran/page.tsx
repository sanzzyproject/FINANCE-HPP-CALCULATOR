...
export default function PengeluaranPage() {
  ...
  const loadData = async () => {
    ...
    setTransactions(data.filter(t => t.type === 'expense').sort((a, b) => new Date(b.date).getTime() - new Date(a.date).getTime()));
  };
  ...
  const onSubmit = async (data: FormData) => {
    if (editingId) {
      await updateData('transactions', { id: editingId, type: 'expense', ...data });
    } else {
      await addData('transactions', { type: 'expense', ...data });
    }
